 ...
 */
?>
<div id="carousel-bootstrap" class="carousel slide" data-ride="carousel">
  <?php
      ...
      <?php foreach ($carousel_items as $id => $carousel_slide) : ?>
        <div class="item<?php ($id == '0') ? print ' active' : print ''; ?>">
          <?php if (!empty($carousel_slide['carousel_image'])) : ?>
            <?php $img_url = image_style_url('front_carousel_image', file_load($carousel_slide['carousel_image'])->uri); ?>
  ...
  <?php if ($arrow_enabled) : ?>
    ...
    <a class="left carousel-control" href="#carousel-bootstrap" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
    <a class="right carousel-control" href="#carousel-bootstrap" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
    <?php endif; ?>
